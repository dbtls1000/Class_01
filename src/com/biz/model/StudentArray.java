...
public class StudentArray {
	...
	public Student[] makeScore(int stdLen) {
		...
		// 숫자형배열은 배열을 초기화하면 각 개별값이 0으로 생성
		int[] intA = new int[10];

		// 문자열형 배열은 배열을 초기화하면 각 개별값이 ""으로 생성
		String[] strA = new String[10];

		// Student 클래스 객체 10개를 예약
		// 예약만 되있고 사용할 준비가 되지 않은 상태
		...
		// 가상의 성적을 만들기위해 난수발생기 사용
		Random rnd = new Random();
		// for반복문을 사용해서 같은 코드를 10번 수행했다.
